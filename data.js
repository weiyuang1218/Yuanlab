  ...
  try {
    ...
    if (resources && resources.length > 0) {
      window.LAB_DATA.resources = resources.map(r => ({
        id: r.id,
        name: r.title || r.name || "",
        category: r.category === "Reference Protocols" ? "Protocols" : (r.category || ""),
...
window.LAB_DATA = {
  ...
  databases: [
    { id: "db1", name: "NCBI GEO", url: "https://www.ncbi.nlm.nih.gov/geo/", description: "Gene expression omnibus — download public RNA-seq / microarray datasets for in silico validation." },
    { id: "db2", name: "TCGA (GDC Portal)", url: "https://portal.gdc.cancer.gov/", description: "The Cancer Genome Atlas — multi-omic data for prostate and other cancers." },
    { id: "db3", name: "GTEx", url: "https://gtexportal.org/", description: "Tissue-specific gene expression and eQTL reference." },
  ],
